...
function fixedEncodeURI(str) {
   ...
   //    Here's an example of using `encodeURI()`: const originalString = "This is an example string: ?#";
...
chrome.contextMenus.onClicked.addListener(function (clickData) {
   ...
   // The clickData.selection and clickData.selectionText properties are part of the clickData object provided when handling a context menu click event in a browser extension. They are related to the selected text on a webpage. clickData.selection: property represents the selected text on the webpage when a context menu item was clicked. It provides more information about the selection, including details like the text, the start offset, and the end offset within the selected text. clickData.selectionText: is a specific property of the clickData object that directly contains the text of the selection. It holds only the text of the selected portion on the webpage.
